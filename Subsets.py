...
SUBSETS.PRIMARY_CONSUMERS = ['ARABIAN BUTTERFLYFISH','BANDED CORAL SHRIMP','BLACK URCHIN','BROOMTAIL WRASSE',
					 ...
					 'MANTAS','PARROTFISH','PENCIL URCHIN','SHORT SPINE URCHIN','SPIDER CRAB','TRIPNEUSTES',
...
############################################
############################################
# Other subsets (Ocean, etc.)
############################################
############################################
SUBSETS.OCEANS = ['PACIFIC','RED SEA','ATLANTIC','INDIAN','EAST PACIFIC','ARABIAN GULF']
